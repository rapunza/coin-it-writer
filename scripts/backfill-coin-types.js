...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, coins, error, updated, _i, _b, coin, type, newMetadata, updateError;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, supabase
                        ...
                        .limit(1000)];
                case 1:
                    _a = _c.sent(), coins = _a.data, error = _a.error;
                    if (error) {
                ...
                case 2:
                    ...
                    coin = _b[_i];
                    if (!coin.metadata || coin.metadata.type)
                        return [3 /*break*/, 4];
                    type = null;
                    ...
                    newMetadata = __assign(__assign({}, coin.metadata), { type: type });
                ...
                case 3:
                    ...
                    if (updateError) {
                        console.error("Failed to update coin ".concat(coin.id, ":"), updateError);
                    }
                    else {
                        updated++;
                        console.log("Updated coin ".concat(coin.id, " with type: ").concat(type));
                    }
                    _c.label = 4;
                case 4:
                    _i++;
                    return [3 /*break*/, 2];
                case 5:
                    console.log("Backfill complete. Updated ".concat(updated, " coins."));
                    return [2 /*return*/];
            }
        });
    });
